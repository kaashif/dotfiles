...
add_binds("normal", {
    ...
    key({}, "w", "Open current youtube video in mplayer",
        function (w)
            local uri = w.view.uri or ""
            luakit.spawn("sh /home/kaashif/bin/play_youtube " .. uri)
        end),

    key({}, "W", "Open current video in mplayer",
        function (w)
            local uri = w.view.uri or ""
            luakit.spawn("sh /home/kaashif/bin/play_net " .. uri)
        end),
