...
(defun color-theme-molokai ()
  ...
  (color-theme-install
   '(color-theme-molokai
     ...
     (default ((t (:foreground "#F8F8F2" :background "#101010"))))
     (bold ((t (:weight bold))))
     ...
     (diff-header ((t (:foreground "#F8F8F2" :background "#101010"))))
     (diff-hunk-header ((t (:foreground "#AE81FF" :background "#101010"))))
     (diff-removed ((t (:foreground "#F92672" :weight bold))))
     (escape-glyph ((t (:foreground "#E6DB74"))))
     (minibuffer-prompt ((t (:foreground "#66D9EF"))))
     (mode-line ((t (:foreground "#F8F8F2" :background "#101010"))))
     (mode-line-buffer-id ((t (:foreground nil :background "#101010" :weight semi-bold))))
     (mode-line-inactive ((t (:foreground "#BCBCBC" :background "#101010"
                                          :box (:line-width 1 :color "#101010")))))
     (mode-line-mousable ((t (:foreground "#BCBCBC" :background "#101010"))))
     (mode-line-mousable-minor-mode ((t (:foreground "#BCBCBC" :background "#101010"))))
     ...
     (highlight ((t (:foreground "#101010" :background "#C4BE89"))))
     ...
     (isearch ((t (:foreground "#C4BE89" :background "#101010"))))
     (isearch-fail ((t (:foreground "#FFFFFF" :background "#333333"))))
     (lazy-highlight ((t (:foreground "#465457" :background "#101010"))))
     ...
     (mumamo-background-chunk-submode ((t (:background "#101010"))))
     ...
     (show-paren-match-face ((t (:foreground "#101010" :background "#FD971F"))))
