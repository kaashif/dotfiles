(setq user-mail-address "kaashif@kaashif.co.uk"
      ...
      smtpmail-gnutls-credentials '(("smtp.zoho.com" 587 nil nil))
      smtpmail-starttls-credentials '(("smtp.zoho.com" 587 "kaashif@kaashif.co.uk" nil))
